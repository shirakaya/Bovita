      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var d=document.documentElement;var mode=null;try{mode=localStorage.getItem("ai_phone_shell_mode_v1");}catch(e3){}if(mode!=="phone"&&mode!=="ipad"&&mode!=="desktop")mode="auto";if(mode==="ipad")d.setAttribute("data-ipad-fixed-shell","1");var ch=${JSON.stringify(shellChannel())};var t=(navigator.maxTouchPoints||0)>0;var s=Math.min(screen.width,screen.height);var m=window.matchMedia("(hover: none) and (pointer: coarse)").matches;if(!m){if(mode==="phone"||mode==="ipad"){d.setAttribute("data-force-mobile","1");m=true;}else if(mode==="auto"&&ch==="beta"&&t&&s>0&&s<=620){d.setAttribute("data-force-mobile","1");m=true;}}if(m&&s>=520&&(ch==="beta"||mode==="phone"||mode==="ipad")){var z=Math.min(window.innerWidth/390,window.innerHeight/844);if(isFinite(z)&&z>1.001){d.style.setProperty("--shell-zoom",z.toFixed(4));try{var p=document.createElement("div");p.style.cssText="position:absolute;left:-9999px;top:0;width:100px;--zp:2;zoom:var(--zp)";d.appendChild(p);var w=p.getBoundingClientRect().width;d.removeChild(p);if(!(w>150)){d.setAttribute("data-zoom-fallback","1");}}catch(e2){}}}}catch(e){}})();`,
          }}
        />
